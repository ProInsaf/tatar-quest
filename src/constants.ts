...
export const TUQAY_HEROES = [
  ...
  { title: "Дию", description: "Дию пэрие сезне су төбенә төшерде! 4 шакмакка артка.", move: -4, image: "https://i.ibb.co/svb0Z57P/photo-2026-04-01-09-14-41-jpg-202604011206.jpg" },
  ...
  { title: "Шаян песи", description: "Песи сезне тырмады! 3 шакмакка артка.", move: -3, image: "https://i.ibb.co/zTY9R3cS/photo-2026-04-01-09-14-41-jpg-202604011227.jpg" },
...
export const TUQAY_QUESTIONS = [
  ...
  { q: "Тукайның 'Шүрәле' балетына музыканы кем язган?", a: ["Фәрит Яруллин", "Рөстәм Яхин", "Әнвәр Бакиров"], correct: 0 },
  { q: "Тукайның туган көне кайчан?", a: ["26 апрель", "30 август", "15 октябрь"], correct: 0 },
  { q: "Тукайның әнисе исеме?", a: ["Мәмдүдә", "Бибимәмдүдә", "Гайшә"], correct: 0 },
  ...
  { q: "Казанның Печән базарыннан Апушны кемнәр уллыкка ала?", a: ["Мөхәммәтвәли белән Газизә", "Cәгъди", "Әхмәт"], correct: 0 },
