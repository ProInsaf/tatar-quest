...
export const TUQAY_HEROES = [
  ...
  { title: "Сәгъди абзый", description: "Кырда эшләргә калдыгыз! 3 шакмакка артка.", move: -3, image: "https://i.ibb.co/bM864dHf/photo-2026-04-01-09-14-41-jpg-202604011225.jpg" },
];
...
export const TUQAY_QUESTIONS = [
  ...
  { q: "Тукайның әнисе исеме?", a: ["Бибимәмдүдә", "Айбану", "Гайшә"], correct: 0 },
  ...
  { q: "Тукайның иң якын дусты, язучы кем булган?", a: ["Фатих Әмирхан", "Гаяз Исхакый", "Мәҗит Гафури"], correct: 0 },
  ...
  { q: "Тукай кайсы хастаханәдә дәваланган?", a: ["Клячкин хастаханәсе", "Земство хастаханәсе", "Хәрби госпиталь"], correct: 0 },
  ...
  { q: "Тукай эшләгән газеталарның берсе?", a: ["«Әл-ислах»", "«Вакыт»", "Нур"], correct: 0 },
